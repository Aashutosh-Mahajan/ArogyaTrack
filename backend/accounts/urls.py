...
urlpatterns = [
    ...
    path("login/2fa/", TwoFactorLoginView.as_view(), name="password-login-2fa"),
    path("login/2fa/resend/", ResendTwoFactorCodeView.as_view(), name="password-login-2fa-resend"),
