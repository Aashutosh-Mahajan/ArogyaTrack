        ...
        {roles.map((role, i) => {
          ...
          return (
            <Link
              key={role.title}
              href={role.href}
              className="group relative flex flex-col w-[240px] rounded-[20px] p-9 pb-6 cursor-pointer transition-all duration-[250ms] ease-out hover:-translate-y-2 hover:shadow-[0_20px_48px_rgba(92,168,140,0.15)] max-[768px]:w-full max-[768px]:mb-3"
              style={{
              ...
              onMouseEnter={(e) => {
                ...
                el.style.backgroundColor = '#2b241c';
                el.style.borderColor = 'rgba(92,168,140,0.6)';
                el.style.animationName = 'fadeUpRole';
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget;
                el.style.backgroundColor = '#211c16';
                el.style.borderColor = 'rgba(92,168,140,0.15)';
