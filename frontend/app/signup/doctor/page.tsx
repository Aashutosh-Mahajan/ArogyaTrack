...
import { FiMail, FiUser, FiPhone, FiLock, FiBriefcase, FiAward } from 'react-icons/fi';
...
export default function DoctorSignupPage() {
  ...
  const signupForm = useForm<DoctorSignupFormData>({
  ...
  const onSignupSubmit = async (data: DoctorSignupFormData) => {
    try {
              ...
              <form onSubmit={signupForm.handleSubmit(onSignupSubmit)} className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        {...signupForm.register('medicalLicense')}
                        type="text"
                        placeholder="MD12345"
                        className="pl-10"
                      />
                    </div>
                    {signupForm.formState.errors.medicalLicense && (
                      <p className="text-sm text-red-600">
                        {signupForm.formState.errors.medicalLicense.message}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {signupForm.formState.errors.specialization && (
                      <p className="text-sm text-red-600">
                        {signupForm.formState.errors.specialization.message}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="text-center text-sm space-y-2">
                  <div>
                    ...
                    <Link href="/login/doctor" className="text-blue-600 hover:text-blue-700 font-medium">
                      Login
                    </Link>
                  </div>
                  <div>
