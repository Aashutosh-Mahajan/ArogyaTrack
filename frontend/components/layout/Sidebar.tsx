...
const patientNav: NavItem[] = [
  ...
  { icon: 'prescriptions', label: 'sidebar_prescriptions', isTranslationKey: true, href: '/dashboard/prescriptions' },
  ...
  { icon: 'downloads', label: 'sidebar_downloads', isTranslationKey: true, href: '/dashboard/downloads' },
];
